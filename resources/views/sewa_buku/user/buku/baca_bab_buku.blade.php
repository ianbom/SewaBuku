...
<div class="container mx-auto p-10 bg-white">
    ...
    <!-- Isi Bab -->
    <div class="mb-8">
        <p class="text-[#979797] leading-relaxed selectable" id="isiBab">{{ $detailBuku->isi ?? 'Isi tidak tersedia.' }}</p>
    ...
    <div class="flex items-center justify-between p-4 border border-[#1E90FF] border-2 rounded-[16px] mt-10 mb-8">
        @if ($quiz)
            ...
            <div class="flex items-center space-x-8">
                @if ($quizScore)
                    <button class="w-full bg-[#1E90FF] text-white py-2 text-sm rounded-[12px] font-bold">
                        Nilai : {{ $quizScore }}
                    </button>
                @endif
