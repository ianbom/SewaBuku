...
<div class="container mx-auto mt-10 p-10">
 ...
 <div class="flex justify-between items-center mb-12">
    <h1 class="text-3xl font-bold text-left text-[052D6E]" style="font-family: 'Libre Baskerville', serif; color: #052D6E;">Subscription Packages</h1>
</div>
...
<div id="orderModal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center hidden z-50">
    <div class="bg-white rounded-[16px] p-6 w-[90%] sm:w-[80%] md:max-w-md">
        <h3 class="text-[16px] font-bold text-[#052D6E] mb-4" style="font-family: 'Inter', sans-serif;">Subscription Confirmation</h3>
