...
<div class="container mx-auto p-10">
    ...
    <div class="mb-20">
        <div class="flex mt-6 mb-6 items-center">
            ...
            <h2 class="text-[18px] font-semibold text-[#052D6E]" style="font-family: 'Inter', sans-serif;">Saved</h2>
                ...
                <div
                    ...
                    <a href="{{ route('user.buku.show', $book->id_buku) }}">
                        @if ($book->coverBuku && $book->coverBuku->first())
                            <img src="{{ asset('storage/' . $book->coverBuku->first()->file_image) }}" alt="Book Cover"
        ...
        <div class="mt-10">
            <div class="flex mt-6 mb-6 items-center">
                ...
                <h2 class="text-[18px] font-semibold text-[#052D6E]" style="font-family: 'Inter', sans-serif;">Finished</h2>
