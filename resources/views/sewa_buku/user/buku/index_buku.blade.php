...
@section('content')
    ...
    <div class="container mx-auto sm:p-10 p-12 px-6">
        <!-- Header Section -->
        <div class="mb-4">
            <h1 class="text-[40px] font-bold text-left text-[#052D6E] sm:mb-10 mt-10" style="font-family: 'Libre Baskerville', serif;">
                Explore</h1>

            <!-- Last Pickup Section -->
            @if ($terakhirDibaca && $terakhirDibaca->buku->coverBuku->first())
                <h2 class="text-[18px] font-semibold mb-4 text-[#052D6E]" style="font-family: 'Inter', sans-serif;">Last read</h2>
        ...
        <div class="mb-6 mt-10">
            <h2 class="text-[18px] font-semibold text-[#052D6E] mb-4" style="font-family: 'Inter', sans-serif;">Recommended books</h2>
        ...
        @foreach ($parentTags as $parentTags)
            ...
            <div class="flex flex-wrap gap-4">
                @foreach ($parentTags->child as $index => $item)
                    ...
                    @endphp
                    <a href="#" class="px-8 py-3 rounded-[16px]" style="background-color: {{ $color['bg'] }}; color: {{ $color['text'] }};">
