...
<div class="container mx-auto p-10">
    ...
    <div class="mb-6 mt-10">
        <h2 class="text-[18px] font-semibold text-[#052D6E] mb-4" style="font-family: 'Inter', sans-serif;">Rekomendasi buku</h2>
    ...
    <h2 class="text-[18px] font-semibold mb-4 mt-6 text-[#052D6E]" style="font-family: 'Inter', sans-serif;">{{ $parentTags->nama_tags }}</h2>
