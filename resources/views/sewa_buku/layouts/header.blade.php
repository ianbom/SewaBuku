...
<div class="flex h-screen bg-gray-100">
    ...
    <div class="flex-1 sm:ml-64"
        @if (Route::currentRouteName() === 'sewa_buku.user.landing') style="background-color: white;"
    @else
        style="background-image: url('{{ asset(path: 'images/bg.png') }}'); background-size: cover; background-position: center; background-color: white;" @endif>
        @yield('content')
    </div>
