                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.buku.update', $buku->id_buku) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tahun_terbit" id="tahun_terbit" class="form-control" value="{{ old('tahun_terbit', $buku->tahun_terbit) }}" required>
                                @error('tahun_terbit')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="link_pembelian" id="link_pembelian" class="form-control" value="{{ old('link_pembelian', $buku->link_pembelian) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <audio controls>
                                    <source src="{{ Storage::url($buku->teaser_audio) }}"
                                        type="audio/mp3">
                            ...
                            <div class="mb-3">
                                ...
                                <audio controls>
                                    <source src="{{ Storage::url($buku->ringkasan_audio) }}"
                                        type="audio/mp3">
                                    Browser Anda tidak mendukung pemutar audio.
                                </audio>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="is_free" id="is_free" class="form-select">
                                    <option value="0" {{ old('is_free', $buku->is_free) == 0 ? 'selected' : '' }}>Tidak</option>
                                    <option value="1" {{ old('is_free', $buku->is_free) == 1 ? 'selected' : '' }}>Ya</option>
                                </select>
                            </div>
                            <!-- Submit Button -->
                            <div class="mt-4 text-end">
                                <a href="{{ route('admin.buku.index') }}" class="btn btn-secondary">Cancel</a>
                                <a href="{{ route('admin.tagsBuku.edit', $buku->id_buku) }}" class="btn btn-warning">Edit Tags Buku</a>
                                <a href="{{ route('admin.detailBuku.edit', $buku->id_buku) }}" class="btn btn-success">Edit Chapter Buku</a>
