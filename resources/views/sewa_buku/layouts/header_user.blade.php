<header class="bg-white fixed top-0 w-full z-50 ">
    <div class="container mx-auto">
      <div class="flex items-center justify-between py-4">
       ...
       class="bg-gradient-to-r from-[#1E90FF] to-[#052D6E] text-white px-6 py-2 rounded-[16px] hover:bg-blue-600 font-semibold flex items-center space-x-2"
       >Subscribe
    </a>
          </div>

        <!-- Mobile Menu Button -->
        <button id="menu-toggle" class="bg-[#D3E9FF] p-2 rounded-[8px] md:hidden text-[#052D6E] hover:text-[#1E90FF] focus:outline-none mr-6">
