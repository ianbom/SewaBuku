    ...
    @section('content')
        ...
        <style>
            ...
            .star:hover {
                ...
                /* Hover color */
                transform: scale(1.2);
                /* Slightly enlarge on hover for a fun effect */
            }
        ...
        <div class="container mx-auto mt-10 p-10">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
                                ...
                                <div class="flex mt-6 items-center">
                                    ...
                                    <span
                                        class="text-[12px] text-sm text-[#979797] font-bold">{{ number_format($averageRating, 1) }}
                                    </span>
                                </div>
            ...
            @if (auth()->check() && $review->id == auth()->id()) bg-[#F1F8FF] border-[#A3D8FF] @else bg-white border-[#D3E9FF] @endif">
                ...
                <div class="mt-10">
                    @if ($checkLanggananAktif)
                        <div id="ratingModal"
                            ...
                            <div class="bg-white p-8 rounded-lg w-full max-w-md">
                                @if ($ratingCheck)
                                    <h3 class="text-[16px] font-bold text-[#052D6E] mb-4"
                                        style="font-family: 'Inter', sans-serif;">Peringatan</h3>
                                    <p class="text-[#979797] mb-6 text-[14px]" style="font-family: 'Inter', sans-serif;">
                                        Anda sudah memberikan rating untuk buku ini. Terima kasih atas partisipasi Anda!</p>
                    ...
                    @else
                        <h3 class="text-[16px] font-bold text-[#052D6E] mb-4" style="font-family: 'Inter', sans-serif;">
                            Berikan Rating untuk Buku Ini:</h3>
                        <form action="{{ route('user.rating.store', $buku->id_buku) }}" method="POST">
                            ...
                            <div class="mb-4">
                                <textarea id="komentar" name="komentar" rows="3" placeholder="Tuliskan komentar Anda..."
                                    class="block text-[14px] w-full p-4 border rounded-[16px] text-[#979797] border-[#1E90FF] focus:outline-none focus:ring-1 focus:ring-[#1E90FF]"></textarea>
                            </div>

                            <!-- Submit Button -->
                            <div class="flex justify-end">
                                <button type="button" onclick="toggleModal('ratingModal')"
                                    class=" mr-4 px-4 text-bold py-2 bg-[#FFCFC2] text-[#E46B61] rounded-[12px] hover:bg-[#E46B61] hover:text-white">
                                    <strong>Batal</strong>
                                </button>
                                <button type="submit"
                                    class="px-4 py-2 bg-[#1E90FF] text-bold text-white rounded-[12px] hover:bg-[#D3E9FF] hover:text-[#1E90FF]">
