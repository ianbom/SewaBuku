...
@section('content')
    ...
    <div class="container mx-auto mt-10 p-5 sm:p-10">
        <div class="max-w-full">
            <div class="grid md:grid-cols-2 md:grid-cols-12 gap-6">
                <!-- Left Column - Book Image -->
                <div class="md:col-span-1">
                    @if ($buku->coverBuku && $buku->coverBuku->count() > 0)
                        <img src="{{ asset('storage/' . $buku->coverBuku->first()->file_image) }}" alt="Book Cover"
                            class="w-240 h-auto object-contain rounded-[16px]">
                    @else
                        <img src="{{ asset('images/placeholder.png') }}" alt="Placeholder" class="w-full h-auto object-contain rounded-[16px]">
                    @endif
                </div>
        ...
        <!-- Book Synopsis -->
        <div class="mt-12">
            <h3 class="text-[#052D6E] font-bold text-lg mb-4">Book Synopsis</h3>
        ...
        @if ($rating && $rating->count() > 0)
            <div class="mt-8">
                <h3 class="text-[#052D6E] font-bold text-lg mb-4">Reviews</h3>
